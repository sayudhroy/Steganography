 ...
 */
public class Encode extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        verifyStoragePermissions(Encode.this);
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.bEncrypt:
                ...
                Stego obj = new Stego();
                Data.msg = obj.encrypt(text, key);
                obj.embed(Data.msg, Data.imgPath);
                Toast.makeText(Encode.this, "Image Has Been Encoded Successfully", Toast.LENGTH_LONG).show();
                outputText.setText("Filename: Output.jpg");
                //Toast.makeText(Encode.this, "Image Has Been Encoded Successfully", Toast.LENGTH_LONG).show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RESULT_LOAD_IMAGE && resultCode == RESULT_OK && data != null) {
            ...
            Data.imgPath = getPath(this, selectedImage);
            //Toast.makeText(Encode.this, "abc: " + Data.imgPath, Toast.LENGTH_LONG).show();
            Log.e("path", getPath(this, selectedImage) + "\tabc\t" + Data.imgPath);
